...
from .forms import LoginForm, MyPasswordChangeForm, MyPasswordResetForm, MyPasswordResetForm,MySetPasswordForm
...
urlpatterns = [
    ...
    (template_name='shop/passwordchangedone.html',
    form_class=MyPasswordChangeForm,),name='passwordchangedone'),
    path('reset_password/',auth_views.PasswordResetView.as_view
    (template_name='shop/password_reset.html',form_class=MyPasswordResetForm),name='password_reset'),
    ...
    path('registration/', views.CustomerRegistrationFor.as_view(), name="customerregistration"),
